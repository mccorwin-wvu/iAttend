...
public class UserHomePageActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(user == null){
            ...
            DataRequest dataRequest1 = new DataRequest(Integer.toString(user_id), responseListener1);
            RequestQueue queue1 = Volley.newRequestQueue(UserHomePageActivity.this);
            queue1.add(dataRequest1);
            ...
            if (user != null || user.getAdmin_class_list() != null) {
